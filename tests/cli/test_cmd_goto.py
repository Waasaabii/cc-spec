...
from helpers import assert_contains_any, write_yaml
...
class TestGotoCommand:
    ...
    def test_goto_fails_without_project(self, tmp_path, monkeypatch) -> None:
        ...
        assert_contains_any(result.stdout.lower(), ["not in a cc-spec project", "init"])
...
class TestGotoOptions:
    ...
    def test_goto_has_execute_option(self) -> None:
        ...
        assert_contains_any(result.stdout, ["--execute", "-x"])
    ...
    def test_goto_has_force_option(self) -> None:
        ...
        assert result.exit_code == 0
        assert_contains_any(result.stdout, ["--force", "-f"])
