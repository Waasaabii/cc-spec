...
export const translations = {
    zh: {
        ...
        skillsHint: "将 cc-spec skills 安装到当前项目的 .claude/skills",
        skillsVersion: "内置版本",
        ...
        skillsUninstall: "卸载",
        skillsRefresh: "刷新状态",
        skillsNoProject: "请选择项目后管理 Skills",
        skillsEmpty: "暂无 Skills 状态，请刷新或安装",
        skillsInstalled: "已安装",
        skillsMissing: "未安装",
        active: "活跃",
        completed: "已完成",
    ...
    en: {
        ...
        navRuns: "Runs",
        skillsTitle: "Skills Manager",
        skillsHint: "Install cc-spec skills into .claude/skills for this project.",
        ...
        skillsNoProject: "Select a project to manage skills.",
        skillsEmpty: "No skills status yet. Refresh or install.",
